...
var autoresize = (function () {
    ...
    var getMargin = function (dom, elm, pos, computed) {
      var value = parseInt(dom.getStyle(elm, 'margin-' + pos, computed), 10);
    ...
    var resize = function (editor, oldSize) {
      ...
      var marginTop = getMargin(dom, body, 'top', true);
      var marginBottom = getMargin(dom, body, 'bottom', true);
      contentHeight = body.offsetHeight + marginTop + marginBottom;
      if (contentHeight < 0) {
        contentHeight = 0;
      }
      var containerHeight = editor.getContainer().scrollHeight;
      var contentAreaHeight = editor.getContentAreaContainer().scrollHeight;
